 ...
 *
 */
package br.edu.infnet.mail.javamail;
...
import br.edu.infnet.mail.autenticacao.AutenticaUsuario;
...
public class JavaMailBean {
	...
	private static final String 	CONTA_PADRAO = "marcio.biriba@localhost";
